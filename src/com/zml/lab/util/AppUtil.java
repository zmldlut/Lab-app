...
import com.zml.lab.base.BaseModel;
import com.zml.lab.model.Student;
...
public class AppUtil {
    ...
    public static SharedPreferences getSharedPreferences (Context ctx) {
        return ctx.getSharedPreferences("com.zml.global", Context.MODE_PRIVATE);
    }

    public static SharedPreferences getSharedPreferences (Service service) {
        return service.getSharedPreferences("com.zml.global", Context.MODE_PRIVATE);
    }
    ...
    static public String getSessionId () {
        Student customer = Student.getInstance();
